    ...
    <>
      ...
      <div className="sitemap" style={{ margin: " 0px 150px" }}>
        ...
        <div style={{ marginBottom: "30px", marginTop: "20px" }}>
          <h3 style={{ marginBottom: "30px" }}>Most Searching Queries</h3>

          {/* Main Cluster */}
          {/* Inner Cluster 1 Start */}
          <div>
            ...
            >
              <span style={{ color: "#005f9e", fontSize: "15px" }}>
                Accounting Software
              </span>
            </div>
            <div
            ...
            >
              ...
              <span>small business accounting software</span>
            </div>
          </div>
          {/* Inner Cluster 1 End */}
          {/* Inner Cluster 2 Start */}
          <div>
            <div style={{ textAlign: "center" }}>
              <span style={{ paddingLeft: "30px", fontSize: "12px" }}>
              ...
              <span style={{ paddingRight: "30px", fontSize: "12px" }}>
                IT Solution Dubai
              </span>
              <span style={{ paddingRight: "30px", fontSize: "12px" }}>
            ...
            >
              ...
              <span>ecommerce website development dubai</span>
            </div>
          </div>
          {/* Inner Cluster 2 End */}

          {/* Inner Cluster 3 Start */}
          <div>
            <div style={{ textAlign: "right" }}>
              ...
              <span style={{ paddingRight: "30px", fontSize: "12px" }}>
                custom e-commerce development company
              </span>
              <span
                style={{
                  fontSize: "25px",
            ...
            >
              ...
              <span style={{ paddingRight: "10px" }}>
                it solution providers in dubai
              </span>
              <span>software and website development company</span>
            </div>
          </div>
          {/* Inner Cluster 3 End */}

          {/* Inner Cluster 4 Start */}
          <div>
            <div style={{ textAlign: "center" }}>
              <span style={{ paddingRight: "30px", fontSize: "12px" }}>
                it solutions
            ...
            >
              ...
              <span>best digital marketing services</span>
            </div>
          </div>
          {/* Inner Cluster 4 End */}
        </div>
